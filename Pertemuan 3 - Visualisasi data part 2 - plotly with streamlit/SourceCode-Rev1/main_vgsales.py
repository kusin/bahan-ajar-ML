...
st.set_page_config(
  page_title="My Dasboard - Video Games Sales",
  page_icon="",
  layout="wide",
...
# load dataset
dataset = pd.read_csv("../../dataset/dataset_vgsales.csv")
...
with st.container():
  ...
  with col1:
    # show pieplot
    fig = px.pie(df, values='Sales', names='Region', hole=0.5, color_discrete_sequence=px.colors.sequential.RdBu)
    fig.update_layout(
